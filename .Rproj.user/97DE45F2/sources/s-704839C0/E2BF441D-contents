...
empty<-yags(Pres ~ bs(Lat,knots=mean(Lat))+bs(Long,knots=mean(Long)),family=binomial, corstruct="independence",id=Line_Id) 
...
feb1<-yags(Pres ~ bs(Lat,knots=mean(Lat))+bs(Long,knots=mean(Long))+bs(chla_feb1,knots=mean(chla_feb1)),family=binomial, corstruct="independence",id=Line_Id)
