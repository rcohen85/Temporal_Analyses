...
# Using real data, periodic, other settings:
knots = quantile(Jday, probs=c(0.333,0.666))
...
knots = quantile(Jday, probs=c(0.333,0.666))
Jday_mat3 = mSpline(Jday,knots = quantile(Jday,probs=c(0.333,0.666)),Boundary.knots=c(1,365),periodic=T)
...
var_covar_6 = gam(thisSite~s(Jday, bs="cc", k=6), fit=FALSE, family=poisson, 
...
var_covar_4 = gam(thisSite~s(Jday, bs="cc", k=4), fit=FALSE, family=poisson, 
